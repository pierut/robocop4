# RoboCop 3's turkey.py, written during Thanksgiving 2014. Serves some delicious stuff!
...
def turkey(text, action=None):
    """turkey <user> - [From Thanksgiving 2014] Serves <user> some thanksgiving turkey (or ham)."""
    text = text.strip()
