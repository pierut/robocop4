...
def about(text, conn):
    """-- Gives information about RoboCop. Use .about license for licensing information"""
    if text.lower() in ("license", "gpl", "source"):
        return "RoboCop 4 is released under the GPL v3 license, get the source code " \
               "at https://github.com/CloudBotIRC/CloudBot/"

    return "RoboCop 4 is a bot designed to replicate the look and feel of RoboCop Classic. Cloudbot Core: {} - " \
           "https://furcode.co".format(conn.nick, cloudbot.__version__)
